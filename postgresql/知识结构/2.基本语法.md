...
-- 创建第一个分区
CREATE TABLE tablename_partition_range PARTITION OF table_name
    FOR VALUES FROM ('2024-01-01 00:00:00') TO ('2024-02-01 00:00:00');
-- 创建默认分区
CREATE TABLE tablename_partition_default PARTITION OF table_name DEFAULT;
```
